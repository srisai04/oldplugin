...
function spoton_get_ppt_permalink($property)
{
	...
	$pkey = (strlen($property->RKEY)<=6) ? "guid'AE881A9B-A890-406C-B99D-DAAAA9484A03'" : "guid'".$property->RKEY."'";
...
function spoton_get_odata_query($pkey, $post_prefix = '')
{
	...
	$PKey_query = "RKEY eq guid'AE881A9B-A890-406C-B99D-DAAAA9484A03' and";
	$Provider_Key ="guid'".$pkey."'";
	if (!empty($Provider_Key))
		$PKey_query = "RKEY eq ". $Provider_Key;
...
{
	global $spoton_idx, $spoton_pkey;
	$spoton_pkey = "guid'".$spoton_idx->options['provider_key']."'";
}
